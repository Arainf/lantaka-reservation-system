      ...
      <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex justify-center items-center">
        ...
        <button
          ...
          <div className="space-y-2">
            ...
            <p><strong>Guest Type:</strong> {reservation.guestType}</p>
            <p><strong>Reservation Type:</strong> {toSentenceCase(reservation.reservationType)}</p>
            <p><strong>Receipt Date:</strong> {new Date(reservation.receiptDate).toLocaleDateString()}</p>
            <p><strong>Receipt Total:</strong> ${reservation.receiptTotal}</p>
            <p><strong>Receipt Subtotal:</strong> ${reservation.receiptSubTotal}</p>
            <p><strong>Additional Notes:</strong> {reservation.additionalNotes || 'N/A'}</p>
